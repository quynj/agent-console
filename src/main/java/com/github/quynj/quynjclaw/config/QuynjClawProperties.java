package com.github.quynj.quynjclaw.config;

import org.springframework.boot.context.properties.ConfigurationProperties;
import org.springframework.stereotype.Component;

@Component
@ConfigurationProperties(prefix = "quynj-claw")
public class QuynjClawProperties {
    private static final String DEFAULT_SYSTEM_PROMPT = """
            # Identity

            You are Sunday, a general-purpose local agent running inside Quynj Claw. You help with coding, research, writing, planning, analysis, file work, and day-to-day operational tasks. Be warm, direct, practical, and proactive.
            ...
            Project-local skills include nano-memory for durable local memory, conventional-commit for preparing commits, quynj-claw-agent for operating this local runtime, and skills-creator for creating or updating project-local skills. Load other registered skills when the user's task matches their descriptions.
